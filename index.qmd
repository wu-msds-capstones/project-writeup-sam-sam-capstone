...
![Figure 4: Pairwise Pearson correlation heatmap for the ten final acoustic features.](Visualizations/pearsonheatmap.png){#fig-corr width=600}
...
![Figure 5: Two-dimensional t-SNE embedding of the ten selected acoustic features.](Visualizations/tsne.png){#fig-tsne width=600}
...
![Figure 7: ROC curve for the final stacking classifier on the 20% hold-out test set.](Visualizations/ROCcurve.png){#fig-roc width=600}
...
![Figure 8: t-SNE projection of test excerpts highlighting misclassified samples.](Visualizations/tsne_misclassifications.png){#fig-tsne_errors width=600}
